		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					@foreach($cat as $cats)
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".{{ $cats->name }}">
						{{ $cats->name }}
					</button>
					@endforeach
				</div>
			...
			<div class="row isotope-grid">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item @foreach($posts->categorys as $cats) {{ $cats->name }}@endforeach">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0 label-new" data-label="New">
							<img src="{{ $posts->featured }}" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="{{ URL('/') }}/product/@foreach($posts->categorys as $cats){{ $cats->name }}@endforeach/{{ $posts->id }}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									{{ $posts->title }}
								</a>
